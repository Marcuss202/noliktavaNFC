"""
Django settings for BackendNFC project.
...
load_dotenv(BASE_DIR.parent / '.env')  # Load environment variables from .env (project root)
...
SECRET_KEY = 'django-insecure-!bhln(x-57_6s&9p376rnq0n=a9dm=e)485cla*#9%y11ynqyz'
